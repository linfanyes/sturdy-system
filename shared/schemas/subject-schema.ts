...
export type SubjectToolSchema = { [key: string]: SubjectToolDef }

export const SUBJECT_TOOLS: SubjectToolSchema = {
  // ============ 语文 ============
  poetry: {
...
export function getSubjectTool(type: string): SubjectToolDef | null {
 ...
 */
export const SUBJECT_LIST: SubjectListItem[] = [
 ...
 */
export const ALL_SUBJECTS: string[] = SUBJECT_OPTIONS.map((s) => s.value)
 ...
 */
export const MATH_TOOLS: MathToolItem[] = [
 ...
 * 按学科名称返回该学科的所有工具列表。
 */
export function getToolsBySubject(subject: string): ToolMenuItem[] {
  if (subject === '数学') {
