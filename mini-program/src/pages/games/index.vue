...
const cats = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: '图片拼图', icon: '🖼️', path: '/pages/games/slidePuzzle', desc: '6 种 emoji 图案切图还原', ctrl: '点相邻块 / 滑动', bg: '#f3e5f5' },
      ...
      { label: '数字推盘', icon: '🎯', path: '/pages/games/slidingPuzzle', tag: '新', tagType: 'new', desc: '顺序/倒序/蛇形/螺旋 4 种目标模式', ctrl: '点相邻块 / 滑动', bg: '#f1f8e9' },
    ],
  },
  {
    title: '动作反应', icon: '⚡',
    items: [
      ...
      { label: '极速摩托', icon: '🏍️', path: '/pages/games/motorcycle', desc: '3 车道道路滚动，速度递增', ctrl: '左右滑切换车道', bg: '#fff3e0' },
      { label: '汽车躲避', icon: '🚗', path: '/pages/games/carCrash', desc: '4 车道高速公路 + 金币系统', ctrl: '左右滑切换车道', bg: '#ffebee' },
  ...
  },
  {
    ...
    items: [
      ...
      { label: '科学知识', icon: '🔬', path: '/pages/games/scienceQuiz', desc: '10 道科学知识问答', ctrl: '点选答案', bg: '#f3e5f5' },
      { label: '人文地理', icon: '🌍', path: '/pages/games/geoQuiz', desc: '10 道地理人文问答', ctrl: '点选答案', bg: '#fce4ec' },
    ],
  },
  {
    title: '创意写作', icon: '📖',
    items: [
      { label: '故事接龙', icon: '📚', path: '/pages/games/storyChain', desc: '一人一句编故事，锻炼想象力与表达', ctrl: '文字输入，轮流接龙', bg: '#e8eaf6', tag: '新', tagType: 'new' },
    ],
  },
]
