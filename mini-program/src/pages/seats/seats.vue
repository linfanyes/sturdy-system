...
.form input { border: 1px solid #eee; border-radius: 12rpx; padding: 20rpx; margin-bottom: 18rpx; font-size: 28rpx; }
.save { background: #07c160; color: #fff; border-radius: 50rpx; margin-top: 12rpx; }
