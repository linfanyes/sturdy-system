<template>
  <view class="page" :class="{ dark: theme.mode === 'dark' }">
    <view class="topbar"><text class="mtitle">🎤 口语练习</text></view>
    <view class="card">
      <view class="sec-title">英语口语对话练习</view>
      <input v-model="form.topic" class="ctrl" placeholder="主题（如：自我介绍、购物、问路）" />
      <input v-model="form.level" class="ctrl" placeholder="难度（初级/中级/高级，默认初级）" />
