...
export const routes: RouteRecordRaw[] = [
  ...
  // 校管
  {
    ...
    children: [
      ...
      { path: 'resource-library', name: 'school-admin-resource-library', component: () => import('@/views/school-admin/ResourceLibrary.vue'), meta: { title: '在线资源库' } },
  ...
  // 教师：全部子路由，meta.feature 控制可见性
  {
    ...
    children: [
      ...
      { path: 'ai-resources', name: 'teacher-ai-resources', component: () => import('@/views/ai/Resources.vue'), meta: { title: '在线资源', feature: 'ai' } },
      ...
      { path: 'resource-library', name: 'teacher-resource-library', component: () => import('@/views/teacher/ResourceLibrary.vue'), meta: { title: '在线资源库', feature: 'ai' } },
      ...
      { path: 'games/colorMatching', name: 'gameColorMatching', component: () => import('@/views/games/GameColorMatching.vue'), meta: { title: '颜色匹配', feature: 'games' } },
