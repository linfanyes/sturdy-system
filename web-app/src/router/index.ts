...
export const routes: RouteRecordRaw[] = [
  ...
  // 超管
  {
    ...
    children: [
      { path: '', name: 'super-dashboard', component: () => import('@/views/super/Dashboard.vue'), meta: { title: '仪表盘' } },
  ...
  // 教师：全部子路由，meta.feature 控制可见性
  {
    ...
    children: [
      ...
      { path: 'resource-library', name: 'teacher-resource-library', component: () => import('@/views/teacher/ResourceLibrary.vue'), meta: { title: '教学资源库', feature: 'ai' } },
