...
const games: GameItem[] = [
  { name: '24点', icon: '🧮', desc: '四张牌算出24', route: '/teacher/games/24point' },
  { name: '2048', icon: '🔢', desc: '合并数字到2048', route: '/teacher/games/2048' },
  { name: '扫雷', icon: '💣', desc: '9×9经典扫雷', route: '/teacher/games/minesweeper' },
  { name: '贪吃蛇', icon: '🐍', desc: '吃食物变长', route: '/teacher/games/snake' },
  { name: '井字棋', icon: '⭕', desc: '三连获胜', route: '/teacher/games/tic-tac-toe' },
  ...
  { name: '数字华容道', icon: '🧠', desc: '15数字归位', route: '/teacher/games/puzzle' },
  ...
  { name: '汽车躲避', icon: '🚗', desc: '避开来车', route: '/teacher/games/car-crash' },
  { name: '数独', icon: '🔢', desc: '9×9数独', route: '/teacher/games/sudoku' },
  { name: '数字排序', icon: '🚂', desc: '按序点击', route: '/teacher/games/sequence' },
  ...
  // 创意型小游戏
  { name: '故事接龙', icon: '📖', desc: '一人一句编故事（创意写作）', route: '/teacher/games/story-chain' },
]
