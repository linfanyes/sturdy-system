...
const sections: ToolSection[] = [
  {
    ...
    items: [
      ...
      { label: '随机决定器', icon: Dices, to: '/teacher/tools/dice', feature: 'tools' },
      { label: '倒计时', icon: Timer, to: '/teacher/tools/timer', feature: 'tools' },
      { label: '课堂计算器', icon: CalcIcon, to: '/teacher/tools/calc', feature: 'tools' },
      { label: '加减分', icon: Trophy, to: '/teacher/tools/score-panel', feature: 'rewards' },
  ...
  },
  {
    ...
    items: [
      { label: '汉字笔顺', icon: PenTool, to: '/teacher/tools/stroke-order', feature: 'tools' },
      { label: '作文素材', icon: FileText, to: '/teacher/tools/writing-materials', feature: 'tools' },
  ...
  },
  {
    ...
    items: [
      ...
      { label: '竖式计算', icon: Hash, to: '/teacher/tools/vertical-calc', feature: 'tools' },
      { label: '口算答题卡', icon: FileQuestion, to: '/teacher/tools/answer-card', feature: 'tools' },
      { label: '乘法口诀', icon: FileText, to: '/teacher/tools/multiplication-table', feature: 'tools' },
      { label: '单位换算', icon: Ruler, to: '/teacher/tools/unit-conversion', feature: 'tools' },
      { label: '错题本', icon: AlertCircle, to: '/teacher/tools/math-mistakes', feature: 'tools' },
    ],
  },
  {
    title: '英语工具', icon: Languages,
    items: [
      { label: '单词卡片', icon: StickyNote, to: '/teacher/tools/word-card', feature: 'tools' },
      { label: '句型练习', icon: AlignLeft, to: '/teacher/tools/sentence-practice', feature: 'tools' },
      ...
      { label: '情景对话', icon: MessagesSquare, to: '/teacher/tools/scene-dialogue', feature: 'tools' },
      { label: '单词拼写', icon: Type, to: '/teacher/tools/spell', feature: 'tools' },
      { label: '口语练习', icon: Mic, to: '/teacher/tools/speaking', feature: 'tools' },
      { label: '英语爽文', icon: BookOpen, to: '/teacher/tools/english-story', feature: 'tools' },
    ],
  },
  {
  ...
  },
  {
    ...
    items: [
      { label: '座位表', icon: LayoutGrid, to: '/teacher/tools/seat-map', feature: 'seats' },
      { label: '班级职务', icon: Library, to: '/teacher/tools/class-duty', feature: 'duty' },
      { label: '课表排版', icon: Calendar, to: '/teacher/tools/schedule-maker', feature: 'schedule' },
    ],
  },
  {
