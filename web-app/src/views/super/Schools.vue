    ...
    <div v-if="showForm" class="fixed inset-0 bg-black/40 flex items-center justify-center z-50">
      <div class="bg-white rounded-2xl p-6 w-full max-w-md">
        ...
        <div class="space-y-3">
          ...
          <div>
            <label class="text-sm text-cocoa-500">编号（6 位，可选）</label>
            <input v-model="form.code" maxlength="6" class="w-full mt-1 px-3 py-2 rounded-xl border border-cream-200 focus:outline-none focus:border-butter-400" placeholder="如 SCH001" />
          </div>
          <div>
