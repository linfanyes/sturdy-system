 ...
 */
export declare function fmt1(n: number | string | null | undefined): string;
/**
 ...
 */
export declare function pctNum(n: number | string | null | undefined): string;
/**
 ...
 */
export declare function scoreColor(score: number | null | undefined, fullScore?: number): string;
