...
exports.FONT_SIZES = exports.SCHEME_VALUES = exports.SCHEMES = exports.FEATURE_FLAG_LIST = exports.FEATURE_FLAGS_SET = exports.FEATURE_FLAG_LABELS = exports.FEATURE_FLAGS = exports.ALL_POSITIONS = exports.SUBJECT_LEADER_POSITIONS = exports.BASE_POSITIONS = exports.ROLE_VALUES = exports.ROLE_OPTIONS = exports.GRADE_OPTIONS = exports.CLASS_NAMING_RULE = exports.PHONE_HINT = exports.PHONE_REGEX = exports.SUBJECT_VALUES = exports.SUBJECT_OPTIONS = void 0;
exports.parseSubjectLeader = parseSubjectLeader;
...
/** 学科值数组（便于校验器直接引用） */
exports.SUBJECT_VALUES = exports.SUBJECT_OPTIONS.map((s) => s.value);
/**
 ...
 */
exports.PHONE_REGEX = /^1[3-9]\d{9}$/;
/** 手机号校验失败提示语 */
exports.PHONE_HINT = '请输入11位手机号';
/**
...
/** 角色值数组（便于校验器引用） */
exports.ROLE_VALUES = exports.ROLE_OPTIONS.map((r) => r.value);
/**
 * 教师职务选项
...
exports.SUBJECT_LEADER_POSITIONS = buildSubjectLeaderPositions();
/** 全部职务选项（基础 + 学科组长），供前端下拉使用 */
exports.ALL_POSITIONS = [...exports.BASE_POSITIONS, ...exports.SUBJECT_LEADER_POSITIONS];
/**
 * 解析职务字符串，提取学科和年级（用于教材编辑权限判断）
 * @returns { subject?, grade? } 学科组长职务返回对应学科和年级；否则返回空
 */
function parseSubjectLeader(position) {
    if (!position)
        return {};
    // 匹配 "{年级}{学科}组长" 或 "{学科}组长"
...
/** 特性标识集合（用于快速 O(1) 查找） */
exports.FEATURE_FLAGS_SET = new Set(exports.FEATURE_FLAGS);
/** 标准功能包清单（双端 UI 直接复用） */
exports.FEATURE_FLAG_LIST = exports.FEATURE_FLAGS.map((k) => ({ key: k, label: exports.FEATURE_FLAG_LABELS[k] || k }));
exports.SCHEMES = [
...
/** 主题色值数组 */
exports.SCHEME_VALUES = exports.SCHEMES.map((s) => s.value);
exports.FONT_SIZES = [
