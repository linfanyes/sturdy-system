...
exports.QUICK_TOOLS = void 0;
exports.getQuickTool = getQuickTool;
exports.QUICK_TOOLS = {
    translate: {
        icon: '🌐',
        title: '翻译',
...
function getQuickTool(type) {
    return exports.QUICK_TOOLS[type] || null;
}
//# sourceMappingURL=quicktool-schema.js.map