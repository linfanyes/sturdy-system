...
CREATE TABLE IF NOT EXISTS `textbooks` (
  ...
  `publisher` varchar(255) NOT NULL DEFAULT '' COMMENT '出版社版本：人教版/外研版',
  `subject` varchar(255) NOT NULL DEFAULT '' COMMENT '学科：语文/数学/英语',
  `grade` varchar(255) NOT NULL DEFAULT '' COMMENT '年级：三年级',
  `term` varchar(255) NOT NULL DEFAULT '' COMMENT '册次：上册/下册',
